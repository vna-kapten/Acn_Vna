...
<head>
    ...
    <title>Register - Toko Thrift</title>
    @vite('resources/css/app.css')
</head>
<body class="bg-gradient-to-br from-indigo-500 to-purple-600 min-h-screen flex flex-col p-4">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="px-8 py-10">
                    <h2 class="text-2xl font-bold text-gray-800 mb-8">Buat Akun Baru</h2>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       class="w-full pl-12 pr-4 py-3 border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                                       required>
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" 
                                       ...
                                       class="w-full pl-12 pr-4 py-3 border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                                       required>
                            </div>
                    ...
                    <p class="text-center text-gray-600 text-sm">
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="text-indigo-600 font-semibold hover:text-indigo-700">Masuk di sini</a>
                    </p>
                </div>

                <!-- Footer Info -->
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-200">
                    <h3 class="text-sm font-bold text-gray-700 mb-3">✓ Keuntungan Bergabung:</h3>
                    <div class="space-y-1 text-xs text-gray-600">
                        <p>✅ Akses ke semua produk toko thrift</p>
                        <p>✅ Belanja dengan harga spesial</p>
                        <p>✅ Tracking pesanan real-time</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer Text -->
    <p class="text-center text-white text-sm py-6">
